...
void Graphic::SetValues(Vector2d pos, int fade, Vector2d zoom, double angle, bool centerPosFlg, bool trans){
	this->pos = pos;
	this->fade = fade;
	this->zoom = zoom;
	this->angle = angle;
...
Graphic* Graphic::Create(string path, Vector2 oneSize, Vector2 patternNum, Vector2d pos, bool centerPosFlg, bool trans, int fade, Vector2d zoom, double angle){
	Graphic* ret = new Graphic();
